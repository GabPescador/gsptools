...
## Unique modified sites/proteins
...
```{r}
DT::datatable(param$results[["Quality Control"]]$tables[["InputUnique"]],
    extensions = 'Buttons',
...
```{r}
DT::datatable(param$results[["Quality Control"]]$tables[["diGlyUnique"]],
    extensions = 'Buttons',
