...
```{r}
# Create ZIP file
zip_file <- paste0(params$report_title, "_results.zip")
zip::zip(zip_file, files = params$excel_files, mode = "cherry-pick")

# Offer for download
cat(sprintf('<a href="%s" download class="btn btn-success">📥 Download All Files (ZIP)</a>', zip_file))
```
