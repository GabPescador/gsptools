...
temp_paths <- file.path(temp_dir, basename(params$excel_files))
file.copy(params$excel_files, temp_paths, overwrite = TRUE)

downloadthis::download_file(
                path = temp_paths,
                output_name = paste0(params$report_title, "_results"),
                button_label = "Download All Excel Files (ZIP)",
                button_type = "primary",
                has_icon = TRUE,
